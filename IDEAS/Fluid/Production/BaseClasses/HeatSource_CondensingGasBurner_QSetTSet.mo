...
model HeatSource_CondensingGasBurner_QSetTSet
  ...
  Modelica.Blocks.Interfaces.RealOutput TBoilerSet
...
public
  ...
  Modelica.Blocks.Interfaces.RealInput TSet "Set temperature for heater"
    annotation (Placement(transformation(extent={{-120,-30},{-80,10}})));
  Modelica.Blocks.Interfaces.RealInput QSet "Set heat for heater"
...
end HeatSource_CondensingGasBurner_QSetTSet;
